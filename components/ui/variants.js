// components/ui/variants.js — pure class-variance definitions.
//
// Kept OUT of "use client" files so Server Components can compose the same
// variant classes (e.g. styled <Link> buttons) without crossing the RSC
// boundary. The interactive <Button/> consumes this from button.jsx.
